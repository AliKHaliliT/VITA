...
import { SpecimenPlate, PageHeader, FilterBar, EmptyState, SafeImage, TagList } from "@/shared/ui";
import { useContent, Project } from "@/entities/record";
import { firstLine, hostLabel } from "@/shared/lib";
