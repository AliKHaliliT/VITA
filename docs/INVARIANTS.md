...
| An experience entry names only known employment kinds, one or a list of them. | `tests/src/entities/record/schema.test.ts` "rejects a kind nobody defined" | listed cases |
